...
{         
	    ...
	    lf.lfItalic = (ps->uTextFlags & TEXT_ITALIC) ? (BYTE)1 : (BYTE)0;
	    lf.lfUnderline = (ps->uTextFlags & TEXT_UNDERLINED) ? (BYTE)1 : (BYTE)0;
	    lf.lfStrikeOut = (ps->uTextFlags & TEXT_STRIKEOUT) ? (BYTE)1 : (BYTE)0;
