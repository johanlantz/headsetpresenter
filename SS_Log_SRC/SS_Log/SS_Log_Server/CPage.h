...
public:
	...
	virtual	int Print(int row,int col,UINT TextFlags,int PointSize,const char* fmt,...);
	virtual	int	Print(int row,int *col,UINT TextFlags,int PointSize,const char* fmt,...);
	//	print using data supplied from user function
	virtual	int Print(int row,int col,UINT TextFlags,int PointSize,int ID);
	//	these use inches
	virtual	double Print(double row,double col,UINT TextFlags,int PointSize,const char* fmt,...);
	virtual	double Print(double row,double *col,UINT TextFlags,int PointSize,const char* fmt,...);
	//	print using data supplied from user function
	...
	virtual	int Print(int row,int col,const char* fmt,...);
	virtual	double Print(double row,double col,const char* fmt,...);
	//	print using data supplied from user function
	virtual	int Print(int row,int col,int ID);
	virtual	double Print(double row,double col,int ID);
	//	print limited to print region 
	virtual	int Print(CPrintRegion* pRegion,int row,int col,UINT TextFlags,int PointSize,const char* fmt,...);
	virtual	double Print(CPrintRegion* pRegion,double row,double col,UINT TextFlags,int PointSize,const char* fmt,...);
	//	print using data supplied from user function
	...
	virtual void	CheckBox(CPrintRegion* pRegion,LPCSTR Caption,BOOL Data,int top,int left,int FontSize,int Direction=LABEL_RIGHT,int LineSize=1,UINT Fillflags=FILL_NONE,UINT TextFlags=TEXT_NORMAL|TEXT_NOCLIP|TEXT_SINGLELINE);
	virtual	void	CheckBox(CPrintRegion* pRegion,LPCSTR Caption,BOOL Data,double top,double left,int FontSize,int Direction=LABEL_RIGHT,int LineSize=1,UINT Fillflags=FILL_NONE,UINT TextFlags=TEXT_NORMAL|TEXT_NOCLIP|TEXT_SINGLELINE);
...
protected:
	...
	virtual	int Print(LPCSTR Text,int StartPos,UINT flags,int PointSize);
