...
#if !defined(AFX_COMMANDS_H__B19619C0_9169_4269_B8CA_31B108751A52__INCLUDED_)
#define AFX_COMMANDS_H__B19619C0_9169_4269_B8CA_31B108751A52__INCLUDED_

#include "SS_Log_AddInTypes.h"

class CCommands : 
	public CComDualImpl<ICommands, &IID_ICommands, &LIBID_SS_Log_AddIn>, 
...
protected:
	...
	class XApplicationEvents : public XEventHandler<IApplicationEvents, 
		&IID_IApplicationEvents, &LIBID_SS_Log_AddIn, 
	...
	class XDebuggerEvents : public XEventHandler<IDebuggerEvents, 
		&IID_IDebuggerEvents, &LIBID_SS_Log_AddIn, 
...
public:
// ICommands methods
	STDMETHOD(SS_Log_AddInCommandMethod)(THIS);
};
...
#endif // !defined(AFX_COMMANDS_H__B19619C0_9169_4269_B8CA_31B108751A52__INCLUDED)
