...
{
	UNREFERENCED_PARAMETER(bFirstTime);
    ...
    //  be localized.
    LPCTSTR szCommand = _T("SS_Log_AddInCommand");
    VARIANT_BOOL bRet;
    CString strCmdString;
    strCmdString.LoadString(IDS_CMD_STRING);
    strCmdString = szCommand + strCmdString;
    CComBSTR bszCmdString(strCmdString);
    CComBSTR bszMethod(_T("SS_Log_AddInCommandMethod"));
    ...
    AfxBeginThread(PipeThread, pApplication);
    
    *OnConnection = (VARIANT_BOOL)VARIANT_TRUE;
	return S_OK;
}
