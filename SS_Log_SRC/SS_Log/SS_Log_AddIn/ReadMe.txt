========================================================================
       DEVELOPER STUDIO ADD-IN : SS_Log_AddIn
========================================================================


The Add-in Wizard has created this SS_Log_AddIn DLL for you.  This DLL not only
...
make up your SS_Log_AddIn DLL.


SS_Log_AddIn.h
	This is the main header file for the DLL.  It declares the
	CSS_Log_AddInApp class.

SS_Log_AddIn.cpp
	This is the main DLL source file.  It contains the class CSS_Log_AddInApp.
...
Commands.cpp, Commands.h
    ...
    a sample command (SS_Log_AddInCommand) which displays a message
...
StdAfx.h, StdAfx.cpp
    ...
    named SS_Log_AddIn.pch and a precompiled types file named StdAfx.obj.
