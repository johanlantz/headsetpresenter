...
public:
	...
	//static DWORD FileCrc32Streams(LPCTSTR szFilename, DWORD &dwCrc32);  //does not compile in VS2003
	static DWORD FileCrc32Win32(LPCTSTR szFilename, DWORD &dwCrc32);
	static DWORD FileCrc32Win32Mod(LPCTSTR szFilename, DWORD &dwCrc32);
