	...
	public class MainForm : System.Windows.Forms.Form
	{
		...
		public MainForm()
		{
			...
			try
			{
				...
				license.LicenseKey = "WoK6ILB46AACOOKQUXTZTixRIQmuOYJYWsLB";
				...
				manager.NetworkDiscovered +=new BlueToolsEventHandler(manager_NetworkDiscovered);
				manager.NetworkLost += new BlueToolsEventHandler(manager_NetworkLost);
				manager.NetworkStackLoaded += new BlueToolsEventHandler(manager_NetworkStackLoaded);
				manager.NetworkStackUnloaded += new BlueToolsEventHandler(manager_NetworkStackUnloaded);
		...
		private void manager_NetworkDiscovered(object sender, BlueToolsEventArgs eventArgs)
		{	
			MessageBox.Show("NetworkDiscovered");
		...
		private void manager_NetworkLost(object sender, BlueToolsEventArgs eventArgs)
		{
			MessageBox.Show("NetworkLost");

			deviceList.Items.Clear();
			serviceList.Items.Clear();
		}

		private void manager_NetworkStackLoaded(object sender, BlueToolsEventArgs eventArgs)
		{
			MessageBox.Show("NetworkStackLoaded");

		}

		private void manager_NetworkStackUnloaded(object sender, BlueToolsEventArgs eventArgs)
		{
			MessageBox.Show("NetworkStackUnloaded");
		}
	}
}
