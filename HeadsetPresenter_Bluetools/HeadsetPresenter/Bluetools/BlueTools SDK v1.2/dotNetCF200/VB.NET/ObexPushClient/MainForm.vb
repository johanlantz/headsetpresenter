...
Public Class MainForm
    ...
    Dim WithEvents m_objectPush As ObexObjectPush = Nothing
    Dim m_streamCurrent As ServiceStream = Nothing
    Dim WithEvents m_deviceSelected As RemoteDevice = Nothing

    Dim m_boolAborted As Boolean = False
    Dim m_boolDenied As Boolean = False
    Dim m_boolUnrecoverableError As Boolean = False

    Private Sub deviceList_SelectedIndexChanged(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub
    Private Sub discoverBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub
    Private Sub sendBtn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs)

    End Sub

    Private Sub discoverBtn_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles discoverBtn.Click

        m_network.DiscoverDevicesAsync()

    End Sub

    Private Sub sendBtn_Click_1(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles sendBtn.Click
        ...
        If sendBtn.Text.Equals("Push") Then
            ...
            Try
                ...
                If Not m_serviceCurrent Is Nothing Then
                    ...
                    If Not m_objectPush Is Nothing And openFileDialog.ShowDialog() = Windows.Forms.DialogResult.OK Then
    ...
    Private Sub deviceList_SelectedIndexChanged1(ByVal sender As Object, ByVal e As System.EventArgs) Handles deviceList.SelectedIndexChanged
