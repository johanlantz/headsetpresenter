...
namespace ObexFTPClientSample
{
	...
	public class StoredDevice
	{
		...
		public StoredDevice(Address address, string name)
		{
	...
	public class AddressBook
	{
		...
		/// <summary>
		/// Returns an StoredDevice[] with all devices stored in the AddressBook.
		/// </summary>
		public StoredDevice[] Devices
		{
			get
			{
				return (StoredDevice[])new ArrayList(m_hashAddressList.Values).ToArray(typeof(StoredDevice));
			}
		}
		...
		public void Close()
		{
			...
			foreach(StoredDevice device in Devices)
			{
